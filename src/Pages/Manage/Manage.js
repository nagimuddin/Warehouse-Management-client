...
import useNewInventory from "../../Hooks/useNewProduct";
...
const Manage = () => {
  ...
  const handelDelete = id => {
    ...
    if (process) {
      const url = `https://automobilereact.herokuapp.com/inventory/${id}`;
            ...
            return (
              <div
                ...
                <div className='inventory-content mt-8 md:mt-0 py-6 px-8 bg-[#F6F6F6] rounded-[10px] md:rounded-r-[10px] md:rounded-l-none transition-all ease-in-out duration-300 hover:bg-slate-700'>
                  ...
                  <h3 className='mt-4 font-bold text-xl text-black hover:text-indigo-600 transition-all ease-in-out duration-300'>
                    <button
