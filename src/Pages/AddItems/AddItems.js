...
const AddItems = () => {
  ...
  const onSubmit = (myData) => {
    const url = "https://pacific-retreat-16456.herokuapp.com/inventory";
  ...
  return (
    <div className="container max-w-xl mx-auto py-24">
      ...
      <form className="flex flex-col gap-4" onSubmit={handleSubmit(onSubmit)}>
        ...
        <textarea className='w-full lg:flex items-center text-sm leading-6 text-slate-400 rounded-md ring-1 ring-slate-900/10 shadow-sm py-1.5 pl-2 pr-3 hover:ring-slate-300 dark:bg-slate-800 dark:highlight-white/5 dark:hover:bg-slate-700' placeholder="About" {...register("content", { required: true })}></textarea>
