                  ...
                  <div className='flex items-center'>
                    ...
                    <div className='hidden md:block'>
                      <div className='ml-10 flex items-baseline space-x-4'>
                        <NavLink
                          to='/'
                          className='px-3 py-2 rounded-md text-lg font-bold hover:bg-indigo-600 hover:text-white transition-all ease-in duration-300'>
                          Home
                        </NavLink>
                        {user && (
                          <NavLink
                      ...
                      <Menu as='div' className='ml-3 relative'>
                        <div>
                          {user ? (
                            ...
                            <Link to='/signin' className='button button-indigo'>
                              Sign In
                            </Link>
                          )}
                        </div>
              ...
              <Disclosure.Panel className='md:hidden'>
                <div className='px-2 pt-2 pb-3 space-y-1 sm:px-3'>
                  <Disclosure.Button
                    as='a'
                    href='/'
                    className='px-3 py-2 rounded-md text-lg font-bold hover:bg-indigo-600 hover:text-white transition-all ease-in duration-300 block'>
                    Home
                  </Disclosure.Button>
                  {user && (
                    <Disclosure.Button
